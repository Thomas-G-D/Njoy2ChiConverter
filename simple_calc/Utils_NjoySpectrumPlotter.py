...
def Njoy_spectrum_plotter(outp, path):
    ...
    ax.semilogy(neutron_group_bndries, neutron_spectrum, label = 'CXS')
    ax.set_xlabel("Energy (MeV)")
    ax.set_ylabel(r'$\frac{\phi(E)}{\Delta \phi(E)}$')
    #ax.set_ylabel(r'$\frac{\phi(E)}{\Sigma \phi(E)}$')
    ax.grid('on')
    ax = fig.add_subplot(1, 2, 2)
    ax.loglog(neutron_group_bndries, neutron_spectrum, label = 'CXS')
    ax.set_xlabel("Energy (MeV)")
    ax.set_ylabel(r'$\frac{\phi(E)}{\Delta \phi(E)}$')
    #ax.set_ylabel(r'$\frac{\phi(E)}{\Sigma \phi(E)}$')
    ax.grid('on')
