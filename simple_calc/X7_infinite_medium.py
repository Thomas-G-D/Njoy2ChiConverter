...
for iso in range(len(filename)):
    ...
    matxsr_5_diff_bins  = (abs(matxsr_diff_free) < 5e-2).sum()/2   # determine the number of bins with relative difference of less than 5%
    matxsr_10_diff_bins = (abs(matxsr_diff_free) < 10e-2).sum()/2  # determine the number of bins with relative difference of less than 10%
