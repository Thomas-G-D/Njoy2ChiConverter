...
Isotopes = ['Al27', 'C12',  'Cd106', 'Cd108', 'Cd110', 'Cd111', 'Cd112', 'Cd113', 'Cd114', 'Cd116', 'Cf252',
            'Cr52', 'Fe56', 'H1', 'He3', 'N14', 'Ni58', 'O16', 'Si28']
#Isotopes = ['Al27']
difference            = {}
...
for i in Isotopes:    
    ...
    source_def["energy"] = 10 # 0.09669  # 18.49
    ...
    MCNP_filename = '../../outputs/ENDF-B-VIII-0/172gxs/MCNP/updated_runs/'+i+'XSout_all.txt'
    
    MCNP_tally = index(MCNP_filename, ['1tally', '14'])
