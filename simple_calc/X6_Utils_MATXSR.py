...
def EditMatrix(file):
    ...
    for grp in range(n_groups):
        ...
        bin_width = hi_bound-lo_bound                   # width of the bin
       # spectrum  = matxsr_data['nwt0'][grp]/ bin_width # spectrum data
    ...
    cf.close()
    return matxsr_data
matxsr_data = EditMatrix('../5_9 meeting/test_matxsr_files/tape41_C12')
